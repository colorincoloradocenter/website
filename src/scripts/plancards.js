        ...
        const card = `
            <div class="plan-card">
                <div class="plan-content">
                    <h3 class="plan-type">${plan.tipo}</h3>
                    <h3 class="plan-name">${plan.nombre}</h3>
                    <span class="price"><sup>S/</sup>${plan.precio}</span>
                    <p class="plan-sessions">${plan.sesiones} ${plan.sesiones === 1 ? 'sesión' : 'sesiones'}</p>
                    <div class="plan-frequency">
                        <span class="font-bold"> ${plan.sesiones === 1 ? 'Frecuencia:' : ''}</span>
